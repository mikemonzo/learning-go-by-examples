...
func main() {
	...
	helpMenu := fyne.NewMenu("Help",
		fyne.NewMenuItem("About", func() {
			dialog.ShowCustom("About", "Close", container.NewVBox(
				...
				widget.NewLabel("Author: Miguel Monzo"),
			), myWindow)
		}))
	...
	gopherImg.SetMinSize(fyne.Size(500, 500)) // by default size is 0,0
